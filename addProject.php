						...
						<div class="card-body p-4">
								...
								<input type="hidden" name="proId" id="proId">
									<div class="col-md-6">
										<label for="input13" class="form-label">Project Name <span class="text-danger">*</span></label>
										<div class="position-relative input-icon">
											<input type="text" class="form-control" name="proName" id="proName" placeholder="Project Name" required> 
											<span class="position-absolute top-50 translate-middle-y"><i class="lni lni-notepad"></i></span>
										</div>
									</div>
                                    <div class="col-md-6">
										...
										<div class="position-relative input-icon">
											<input type="text" class="form-control" name="overAmnt" id="overAmnt" placeholder="Overall Amount" required> 
									...
									<div class="col-md-6">
										...
										<div class="position-relative input-icon">
											<input type="text" class="form-control" name="amntReceived" id="amntReceived" placeholder="Amount Received" required> 
											<span class="position-absolute top-50 translate-middle-y"><i class="lni lni-rupee"></i></i></span>
										</div>
									</div>
									<div class="col-md-6">
										<label for="input13" class="form-label">Balance <span class="text-danger">*</span></label>
										<div class="position-relative input-icon">
									...
									<div class="col-md-6">
										<label for="input18" class="form-label">Payment Status <span class="text-danger">*</span></label>
