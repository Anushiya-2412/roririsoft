						...
						<div class="card-body p-4">
                                ...
                                <input type="hidden" name="editPro" id="editPro">
									...
									<div class="col-md-6">
										...
										<div class="position-relative input-icon">
											<input type="text" class="form-control" id="clientE" name="clientE" placeholder="Clinet Name" required>
									...
									<div class="col-md-6">
										...
										<div class="position-relative input-icon">
											<input type="date" class="form-control" id="endDateE" name="endDateE" placeholder="Start date" required>
											<span class="position-absolute top-50 translate-middle-y"><i class='bx bx-calendar'></i></span>
										</div>
									</div>
                                    <div class="col-md-6">
