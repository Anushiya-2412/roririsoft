...
if (isset($_POST['hdnAction']) && $_POST['hdnAction'] == 'addEnquire') {
    ...
    $requiredFields = ['name', 'compName', 'eEmail', 'ePhone', 'eAddress','details'];
    ...
    $insQuery="INSERT INTO `enquire_tbl`(`e_name`, `e_company_name`, `e_email`, `e_mobile`, `e_address`, `enquire_details`) VALUES ('$name','$compName','$email','$phone','$address','$details')";
